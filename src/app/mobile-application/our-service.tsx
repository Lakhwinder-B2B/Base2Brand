    ...
    <> 
      <div className="container mt-5 mb-5">
         <div className="row text-white align-items-center">
            ...
            <div className="col-md-6 mt-5" data-aos="flip-right">
                <img src={mobile1.src} className="w-75 m-auto m-md-0" alt="" />
            </div>
            <div className="col-md-6 mt-5" data-aos="flip-left">
            ...
            <div className="col-md-12 mt-5 mb-5" data-aos="flip-left">
            ...
            <div className="col-md-12 text-center mt-5" data-aos="flip-right">
