    ...
    <>
      ...
      <div className="bg_home pt-5 pb-5">
        <div className="youtube mb-4">
            <div className="banner-video position-relative d-flex flex-wrap justify-content-center align-items-end" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
