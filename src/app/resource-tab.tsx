    ...
    <>  
        <div className="container-fluid py-0 pb-5"> 
            <div className="row resource text-white mb-5 justify-content-center px-3 px-md-5" data-aos="fade-up"> 
                <h1 className="text-center mb-5">Outsource Web Development To Gain A Competitive Edge</h1>
                    <div className="resource-col col-12 pb-5">
                        <div className="d-flex flex-wrap justify-content-center align-items-center">
                    <nav>
                        <div className ="nav nav-tabs mb-5" id="nav-tab" role="tablist" data-aos="slide-leftgit ">
                    ...
                    <div className="tab-content d-flex flex-wrap w-100 p-3" id="nav-tabContent">
                        <div className="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div className="row d-flex flex-wrap justify-content-center" data-aos="slide-right">
