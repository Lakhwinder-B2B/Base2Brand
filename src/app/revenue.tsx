      ...
      <div className="container-fluid p-5 mt-5"> 
        <div className="row revenue text-white justify-content-center"> 
          <div className="col-12 pb-4">
            <h1 className="text-center font-light fs-3 col-12 col-sm-12 col-lg-5 m-auto d-flex flex-wrap mb-3">Boost Your Revenue Growth with PPC Management Services</h1>
            <p className="col-12 col-sm-12 col-lg-7 ppc-para text-center m-auto d-flex flex-wrap">PPC management requires extensive experience and a data-driven approach. Since we started our PPC agency over 7 years ago, the most important lesson has been the one that the numbers have taught us. This approach has allowed us to work with some of world’s most recognizable brands and deliver exceptional results.</p>
          </div>
          
          <div className="col-12 col-sm-6 col-md-3 col-lg-3 px-lg-5 py-lg-5 px-md-2 px-sm-2 px-2 py-2 revenue-bg">
