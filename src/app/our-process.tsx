        ...
        <div className="row process text-white mb-5 pb-5 justify-content-center"> 
          <div className="col-md-12 pb-4">
            ...
            <div className="process-col text-center col-12 col-sm-6 col-md-4 pb-5">
                <h1 className="text-white"  styles={{ backgroundImage:`url(${Count})` }}>01</h1>
                <h2 className="process-txt">PLANNING</h2>
                <p>We learn your vision for effective implementation in your project.</p>
            </div>

            <div className="process-col text-center col-12 col-sm-6 col-md-4 pb-5">
                <h1 className="text-white"  styles={{ backgroundImage:`url(${Count})` }}>03</h1>
            ...
            <div className="process-col text-center col-12 col-sm-6 col-md-4 pb-5">
                <h1 className="text-white"  styles={{ backgroundImage:`url(${Count})` }}>05</h1>
            ...
            <div className="process-col text-center col-12 col-sm-6 col-md-4 pb-2">
                <h1 className="text-white"  styles={{ backgroundImage:`url(${Count})` }}>02</h1>
            ...
            <div className="process-col text-center col-12 col-sm-6 col-md-4 pb-2">
                <h1 className="text-white"  styles={{ backgroundImage:`url(${Count})` }}>04</h1>
